...
import 'package:getaccess/Students/StudentHomePage.dart';
    ...
    Future<void> _loginUser() async {
      ...
      try {
        ...
        if (querySnapshot.docs.isNotEmpty) {
          ...
          // Navigate to Student Home Page after successful login
          // Replace 'StudentHomePage' with the actual Student Home Page widget
